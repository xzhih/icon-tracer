...
def fixtures() -> list[Fixture]:
    return [
        ...
        Fixture("t_mx", mirror_x(shape_t())),
        Fixture("t_my", mirror_y(shape_t())),
        Fixture("t_r90", rotate90(shape_t())),
        Fixture("t_r180", rotate180(shape_t())),
        Fixture("t_r270", rotate270(shape_t())),
        Fixture("h_shape", shape_h()),
        Fixture("h_mx", mirror_x(shape_h())),
        Fixture("h_my", mirror_y(shape_h())),
        Fixture("h_r90", rotate90(shape_h())),
        Fixture("h_r180", rotate180(shape_h())),
        Fixture("h_r270", rotate270(shape_h())),
        Fixture("hooked_l", shape_hooked_l()),
        Fixture("hooked_l_mx", mirror_x(shape_hooked_l())),
        Fixture("hooked_l_my", mirror_y(shape_hooked_l())),
        Fixture("hooked_l_r90", rotate90(shape_hooked_l())),
        Fixture("hooked_l_r180", rotate180(shape_hooked_l())),
        Fixture("hooked_l_r270", rotate270(shape_hooked_l())),
