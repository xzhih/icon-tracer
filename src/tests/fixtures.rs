...
pub(super) fn parity_plus_bitmap() -> Bitmap {
    const CANVAS: usize = 256;
    let rects = [
...
pub(super) fn parity_l_shape_bitmap() -> Bitmap {
    const CANVAS: usize = 256;
    let rects = [
...
pub(super) fn parity_h_shape_bitmap() -> Bitmap {
    const CANVAS: usize = 256;
    let rects = [
        (58.0, 52.0, 102.0, 204.0, 18.0),
...
pub(super) fn parity_hooked_l_bitmap() -> Bitmap {
    const CANVAS: usize = 256;
    let rects = [
        (58.0, 52.0, 102.0, 204.0, 18.0),
        (58.0, 160.0, 198.0, 204.0, 18.0),
